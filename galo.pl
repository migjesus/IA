...
op1((O,Li),joga11,(X,Lf)):- member(((1,1),vazio),Li),replaceP(((1,1),vazio),((1,1),O),Li,Lf),inv(O,X).
op1((O,Li),joga12,(X,Lf)):- member(((1,2),vazio),Li),replaceP(((1,2),vazio),((1,2),O),Li,Lf),inv(O,X).
op1((O,Li),joga13,(X,Lf)):- member(((1,3),vazio),Li),replaceP(((1,3),vazio),((1,3),O),Li,Lf),inv(O,X).
op1((O,Li),joga21,(X,Lf)):- member(((2,1),vazio),Li),replaceP(((2,1),vazio),((2,1),O),Li,Lf),inv(O,X).
op1((O,Li),joga22,(X,Lf)):- member(((2,2),vazio),Li),replaceP(((2,2),vazio),((2,2),O),Li,Lf),inv(O,X).
op1((O,Li),joga23,(X,Lf)):- member(((2,3),vazio),Li),replaceP(((2,3),vazio),((2,3),O),Li,Lf),inv(O,X).
op1((O,Li),joga31,(X,Lf)):- member(((3,1),vazio),Li),replaceP(((3,1),vazio),((3,1),O),Li,Lf),inv(O,X).
op1((O,Li),joga32,(X,Lf)):- member(((3,2),vazio),Li),replaceP(((3,2),vazio),((3,2),O),Li,Lf),inv(O,X).
op1((O,Li),joga33,(X,Lf)):- member(((3,3),vazio),Li),replaceP(((3,3),vazio),((3,3),O),Li,Lf),inv(O,X).
